...
ALLOWED_EXTENSIONS = {'txt', 'pdf', 'png', 'jpg', 'jpeg', 'gif', 'json', 'params', 'onnx', 'prototxt', 'caffemodel', 'pth', 'ckpt', 'meta'}
...
@app.route('/compiler/v1.0/HQCompiler_model_convert', methods=['GET', 'POST'])
       ...
       <body>
          ...
          <script>
            function begin_download_params() {
                window.location.href='http://$HOST:$PORT/mxnet_params_file_download?fileId=pytorch_to_tensorflow.tar.gz'
            }
...
def tensorflowmodel_convert_to_pytorch():
    ...
    <html>
       <body>
          <div>
          Tensorflow模型转pytorch模型成功
          </div>
          <div>
          <button onclick="begin_download_params()">Pytorch模型文件下载</button>
          <!--button onclick="begin_download_json()">Json file download</button-->
          </div>
          <script>
            function begin_download_params() {
                window.location.href='http://$HOST:$PORT/mxnet_params_file_download?fileId=tf_convert_pytorch.pth'
            }
            function begin_download_json() {
                window.location.href='http://$HOST:$PORT/mxnet_json_file_download?fileId=convertedmodel-symbol.json'
            }
...
def caffemodel_convert_to_pytorch():
    ...
    <html>
       <body>
          ...
          <script>
            function begin_download_params() {
                window.location.href='http://$HOST:$PORT/mxnet_params_file_download?fileId=caffe_convert_pytorch.pth'
            }
            function begin_download_json() {
                window.location.href='http://$HOST:$PORT/mxnet_json_file_download?fileId=convertedmodel-symbol.json'
            }
...
def mxnetmodel_convert_to_pytorch():
    ...
    <html>
       <body>
          ...
          <script>
            function begin_download_params() {
                window.location.href='http://$HOST:$PORT/mxnet_params_file_download?fileId=mxnet_convert_pytorch.pth'
            }
            function begin_download_json() {
                window.location.href='http://$HOST:$PORT/mxnet_json_file_download?fileId=convertedmodel-symbol.json'
            }
...
@app.route('/compiler/v1.0/ir_fpga_optimization', methods=['GET', 'POST'])
def ir_fpga_optimization():
    html = Template("""
    <!DOCTYPE html>
    <html>
       <body>
          ...
          <div>
          <button onclick="begin_download_params()">指令集下载</button>
          <button onclick="begin_download_json()">数据流下载</button>
          </div>
          <script>
            function begin_download_params() {
                window.location.href='http://$HOST:$PORT/mxnet_params_file_download?fileId=instruction_FPGA.bin'
            }
            function begin_download_json() {
                window.location.href='http://$HOST:$PORT/mxnet_json_file_download?fileId=biasscaleshift.bin'
            }
          </script>
       </body>
    </html>
    ...
    #user_info = request.values.to_dict()
    #opt_level = user_info.get("opt_level")
    #print(caffe_convert_mxnet_upload_filelist[0])
    #print(caffe_convert_mxnet_upload_filelist[1])
    #print(mxnet_model_upload_userinfolist[0])
    #print(mxnet_model_upload_userinfolist[1])
    ...
    #print(mmtomodel_command)
    #val3 = os.system(mmtomodel_command)
    compile_command = 'rm -f biasscaleshift.bin && python json2model_npy1.py && python load_weights2.py && python opt_2_5.py --optlevel 2  && python post3.py && python extram_coe4.py && python extra_prame_coe.py && python inform_instruc5.py && python instruction6.py'
    #compile_command = 'bash complier_model1.sh 3'
    print(compile_command)
    val = os.system(compile_command)
    command1 = 'python json2model_npy1.py'
    command2 = 'python load_weights2.py'
    command3 = 'python opt_2_5.py --optlevel 3'
    command4 = 'python post3.py'
    command5 = 'python extram_coe4.py'
    command6 = 'python extra_prame_coe.py'
    command7 = 'python inform_instruc5.py'
    command8 = 'python instruction6.py'
    #val1 = os.system(command1)
    #val2 = os.system(command2)
    #val3 = os.system(command3)
    #val4 = os.system(command4)
    #val5 = os.system(command5)
    #val6 = os.system(command6)
    #val7 = os.system(command7)
    #val8 = os.system(command8)
    print("The model has been compiled successfully")
    return html

@app.route('/compiler/v1.0/ir_fpga_no_optimization', methods=['GET', 'POST'])
def ir_fpga_no_optimization():
    html = Template("""
    <!DOCTYPE html>
    <html>
       <body>
    ...
    #print(mmtomodel_command)
    #val3 = os.system(mmtomodel_command)
    compile_command = 'python json2model_npy1.py && python load_weights2.py && python opt_2_5.py --optlevel 0  && python post3.py && python extram_coe4.py && python extra_prame_coe.py && python inform_instruc5.py && python instruction6.py'
    #compile_command = 'bash complier_model1.sh 3'
    print(compile_command)
    val = os.system(compile_command)
    command1 = 'python json2model_npy1.py'
    command2 = 'python load_weights2.py'
    command3 = 'python opt_2_5.py --optlevel 0'
    command4 = 'python post3.py'
    command5 = 'python extram_coe4.py'
    command6 = 'python extra_prame_coe.py'
    command7 = 'python inform_instruc5.py'
