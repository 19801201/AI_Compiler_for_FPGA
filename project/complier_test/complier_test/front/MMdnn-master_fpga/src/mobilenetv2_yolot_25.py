...
class mobilenetv2(nn.Module):
    ...
    def __init__(self, anchors=[(1.3221, 1.73145), (3.19275, 4.00944), (5.05587, 8.09892), (9.47112, 4.84053),
        ...
        self.conv_0 = Conv_BN_LeakyReLU(1, 16, 3, 1, 2)
        self.conv_2 = Conv_BN_LeakyReLU(16, 32, 3, 1, 1)
        # self.conv_4 = Conv_BN_LeakyReLU(78, 78, 3, 1, 1)
        # self.conv_5 = Conv_BN_LeakyReLU(78, 78, 3, 1, 1)
        self.conv_6 = Conv_BN_LeakyReLU(32, 64, 3, 1, 1)
        self.conv_8 = Conv_BN_LeakyReLU(64, 128, 3, 1, 2)
        self.conv_9 = Conv_BN_LeakyReLU(128, 256, 3, 1, 1)
        self.conv_10 = Conv_BN_LeakyReLU(256, 512, 3, 1, 1)   # 
        # self.conv_12 = Conv_BN_LeakyReLU(315, 315, 3, 1, 1)
        self.conv_13 = Conv_BN_LeakyReLU(512, 256, 3, 1, 2)
        self.conv_14 = Conv_BN_LeakyReLU(256, 256, 3, 1, 1)
        self.conv_15 = Conv_BN_LeakyReLU(256, 256, 3, 1, 1)
        self.conv_16 = Conv_BN_LeakyReLU(256, 128, 3, 1, 1) #
        ...
        self.conv_28 = Conv_BN_LeakyReLU(256+128, 256, 3, 1, 2)
